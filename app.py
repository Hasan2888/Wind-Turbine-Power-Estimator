...
# Set path relative to the app script location
SCRIPT_DIR = Path(__file__).parent
TURBINE_IMAGE_URL = SCRIPT_DIR / "turbine.jpeg"
...
TURBINE_IMAGE_URL = "turbine.jpeg"
...
try:
    st.image("us_wind_map.png", use_container_width=True)
except:
